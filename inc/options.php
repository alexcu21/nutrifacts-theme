<?php
add_action( 'cmb2_admin_init', 'nf_options_theme' );
/**
 * Hook in and register a metabox to handle a theme options page and adds a menu item.
 */
function nf_options_theme() {
	...
	$cmb_options = new_cmb2_box( array(
		'id'           => 'nf_options_theme',
		'title'        => esc_html__( 'NutriFacts Theme Options', 'cmb2' ),
		...
		'option_key'      => 'nf_theme_options', // The option key and admin menu page slug.
	...
	$cmb_options->add_field( array(
						'name'    => esc_html__( 'Number of Products on Index ', 'cmb2' ),
	...
	$cmb_options->add_field( array(
				'name'    => esc_html__( 'Number of Brands on Index ', 'cmb2' ),
 ...
 * }
 */
function nf_options_theme_msg( $cmb, $args ) {
...
add_action( 'wp_footer', 'nf_options_styles' );
